...
const PARTNERS = [
  ...
  { name: "Heather Harmon", initials: "HH", role: "Founding Partner", desc: "Four-time founder and public company executive; co-founder of RedDoor (exit to Opendoor).", url: "https://www.linkedin.com/in/heatheraharmon/", photo: headshotHeatherHarmon },
  ...
  { name: "Drew Meyers", initials: "DM", role: "Founding Partner", desc: "Geek Estate founder; co-founder of Horizon; early Zillow team member.", url: "https://www.linkedin.com/in/drewmeyers/", photo: headshotDrewMeyers },
];
    ...
    <div className="bg-background text-foreground min-h-screen">
      ...
      <section className="hero-section min-h-screen flex flex-col justify-center items-start px-[6vw] md:px-[10vw] pt-40 pb-24 relative">
        ...
        <motion.h1 custom={2} variants={fadeUp} initial="hidden" animate="visible" className="serif-display text-[clamp(3rem,7vw,7rem)] leading-[1.0] tracking-tight max-w-[20ch] mb-6 text-primary-foreground">
          Proptech Builders<br />Investing in Proptech <em className="italic text-accent">Builders</em>
        </motion.h1>
